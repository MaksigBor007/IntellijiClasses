...
abstract public class Marks {
     ...
     * by student A and in 4 subjects by student B. Create class 'Marks' with an abstract method
     * 'getAverage' that will be returning the average of marks.
